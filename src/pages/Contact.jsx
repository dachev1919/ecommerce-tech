        ...
        <>
            ...
            <section className="contact">
                <Container>
                    ...
                    />
                    <div className='contact__form mt-5 card-wrapper d-flex flex-wrap align-items-start justify-content-between'>
                        <div className="w-50 contact__form-left">
                            <h4 className='section-heading mt-2'>Contact</h4>
                            <form onSubmit={e => formSubmitHandler(e)}>
                                <div>
                                    <input value={mail} onChange={e => setMail(e.target.value)} type="text" className='form-control mb-3' placeholder='Name' required />
                                </div>
                                <div>
                                    <input value={name} onChange={e => setName(e.target.value)} type="text" className='form-control mb-3' placeholder='Email' required />
                                </div>
                                <div>
                                    <input value={phone} onChange={e => setPhone(e.target.value)} type="text" className='form-control mb-3' placeholder='Phone number' required/>
                                </div>
                                <div>
                                    <textarea value={message} onChange={e => setMessage(e.target.value)} name="" className='form-control mb-4' cols="30" rows="10" placeholder='Comment'></textarea>
                                </div>
